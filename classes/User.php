...
class User {
    ...
    public static function createUser($connection, $first_name, $second_name, $email, $password, $recaptchaSuccess, $role) {
        ...
        try {
            if ($stmt->execute()) {
                ...
                throw new Exception("Create user info failed");
            }
        } catch (Exception $e) { 
            error_log("Chyba u funkce createUser, získaná data selhala\n", 3, "../errors/error.log");
            echo $e->getMessage();    
        }       
    }
    ...
    public static function authentication($connection, $log_email, $log_password) {
        ...
        try {
            ...
            error_log("Chyba u funkce authentication, získaná data selhala\n", 3, "../errors/error.log");
            echo $e->getMessage();
        }    
    }
